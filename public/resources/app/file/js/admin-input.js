$(function () {
    ...
    $('[data-provides="boone.file"]').each(function () {
        ...
        modal.on('click', '[data-file]', function (e) {
            ...
            wrapper.find('.selected').load('/content/file/upload-selected?uploaded=' + $(this).data('file'), function () {
                modal.modal('hide');
            });
        ...
        $(wrapper).on('click', '[data-dismiss="file"]', function (e) {
            ...
            wrapper.find('.selected').load('/content/file/upload-selected', function () {
                modal.modal('hide');
            });
        });
    });
