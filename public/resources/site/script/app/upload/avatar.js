$(function() {
    ...
    dropzone.on('sending', function () {
        uploader.find('#uploaded').html(element.data('uploading') + '...');
    });
    ...
    dropzone.on('success', function (file) {
        ...
        $('#boone-avatar').attr('src', response.path);
        $('#userphoto').val(response.path);
    ...
    dropzone.on('queuecomplete', function () {
        ...
        uploader.find('.uploaded').html(element.data('loading') + '...');
    });
});